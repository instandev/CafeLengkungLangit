...
public class tiketayunan extends AppCompatActivity {
    FirebaseFirestore db;
    ViewLoadingDialog loadingDialog;
    SimpleDateFormat df, df1, df3;
    String id, namaid, tanggalinput, num, num1, num2, strnama, jumlahtiket, jaminput, jamc, hargaprahu, hargaprahu2;
    TextView print, nomorantri, print2;
    EditText jumlah;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tiketayunan);
        ...
        hargaprahu = intent.getStringExtra("harga1");
        hargaprahu2 = intent.getStringExtra("harga2");
        if (btsocket == null) {
        ...
        loadingDialog = new ViewLoadingDialog(tiketayunan.this);
        ...
        print2 = (TextView) findViewById(R.id.print1);
    ...
    print2.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            jumlahtiket = jumlah.getText().toString();
            jmlh = 2;
            double hrg = Double.parseDouble(hargaprahu2);
            ttl = hrg;
            Random rnd = new Random();
            Random rnd1 = new Random();
            Random rnd2 = new Random();
    ...
    private void cetak1(){
        ...
        try {
            ...
            printCustom("--------------------------------\n", 1, 1);
            printCustom("Tiket ini berlaku untuk 1 Kali", 1, 1);
            printCustom("Harga  : "+formatRupiah(Double.valueOf(hargaprahu2)), 1, 0);
            printCustom("Jumlah : "+String.format("%.0f", jmlh)+ " Orang", 1, 0);
            printCustom("Total  : " + formatRupiah(ttl), 1, 0);
            String msg3 = "\n-----" + tanggalinput + "----" + jaminput + "-----" + "\n";
            printCustom(msg3, 1, 1);
